...
const Contact = () => {
    return (
 <div className='grid grid-cols justify-center py-32 min-h-screen'>
...
<div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-32 mt-6'>
            <div>
                <div class="card w-64  shadow-xl">
                    ...
                    <h1 className='text-white font-bold  text-1xl text-center'>+08801308839397</h1>
            ...
            <div>
                <div class="card w-64  shadow-xl">
                    ...
                    <h1 className='text-white font-bold  text-1xl text-center'>mozahidwebmin11d10@gmail.com</h1>
