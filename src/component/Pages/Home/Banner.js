        ...
        <div className='banner py-12'>
            ...
            <BsCodeSlash></BsCodeSlash>
                 ...
                 <div className='px-16 mt-16'>
                        ...
                        <p class=" text-1xl mt-6   text-white">I enjoy learn new skills and implementin then in real life.I like programming.<br></br>I am always ready to learn new frameworks/technologies to keep myself update with the latest market trends.</p>
